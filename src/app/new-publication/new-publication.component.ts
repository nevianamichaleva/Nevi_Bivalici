...
export class NewPublicationComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    tinymce.init({
      ...
      toolbar: "insertfile undo redo | sizeselect | bold italic | fontsizeselect | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image",
